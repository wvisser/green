...
public class GruliaServiceTest {
	...
	public void test00() {
		...
		IntVariable v1 = new IntVariable("v0", 10, 100);
		IntConstant c1 = new IntConstant(10);
//        IntVariable v2 = new IntVariable("v0", -10, 99);
		IntConstant c2 = new IntConstant(100);
//        IntConstant c3 = new IntConstant(-1);

		Operation o1 = new Operation(Operation.Operator.LT, v1, c2);
