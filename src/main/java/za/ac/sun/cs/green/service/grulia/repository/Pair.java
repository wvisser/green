...
public class Pair<L, R> {
	 ...
	 *
	 * @param l the first component of the pair.
	 * @param r the second component of the pair.
	 */
	public Pair(L l, R r) {
		this.l = l;
		this.r = r;
	 ...
	 *
	 * @param l the new value for the first component of the pair.
	 */
	 ...
	 *
	 * @param r the new value for the second component of the pair.
	 */
