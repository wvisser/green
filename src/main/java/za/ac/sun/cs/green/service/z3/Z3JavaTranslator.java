	...
	public void postVisit(IntVariable variable) {
		...
		if (v == null) {
			...
			try {
				...
				// now add bounds
				BoolExpr low = context.mkGe((ArithExpr) v, context.mkInt(lower));
				Operation eLow = new Operation(Operation.Operator.GE, variable, new IntConstant(lower));
				asserts.put(eLow, low);
				BoolExpr high = context.mkLe((ArithExpr) v, context.mkInt(upper));
	...
	public void postVisit(RealVariable variable) {
		...
		if (v == null) {
			...
			try {
				...
				// now add bounds
				BoolExpr low = context.mkGe((ArithExpr) v, context.mkReal(lower));
				BoolExpr high = context.mkLe((ArithExpr) v, context.mkReal(upper));
