...
public class ConstantPropogation extends BasicService {
	...
	private static class OrderingVisitor extends Visitor {
		...
		// i added this
		private HashMap<Expression, Expression> map2;

		public OrderingVisitor() {
			stack = new Stack<Expression>();
			map2 = new HashMap<Expression, Expression>();
		}
		...
		public void postVisit(IntVariable variable) {
			// System.out.println("-----Map.get " + map2.get(variable));
			if (map2.get(variable) != null) {
				stack.push(map2.get(variable));
			} else {
				stack.push(variable);
			}
			// System.out.println("-----postVisit variable push: " + variable);
		}
