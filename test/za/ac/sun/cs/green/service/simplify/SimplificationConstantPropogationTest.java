...
public class SimplificationConstantPropogationTest {
    ...
    /**
     * x == 1 && x + 1 > 0, as per the example given on SunLearn
     */
    @Test
    public void test09() {
        IntVariable x = new IntVariable("x", 0, 99);
        ...
        Operation o1 = new Operation(Operation.Operator.EQ, x, c1);

        Operation o2 = new Operation(Operation.Operator.ADD, x, c1);
        Operation o3 = new Operation(Operation.Operator.GT, o2, c0);
