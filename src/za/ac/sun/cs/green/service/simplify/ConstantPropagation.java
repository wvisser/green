			...
			if (nop != null) {
				...
				switch (op) {
					case EQ:
						...
						} else if (((Operation)l).getOperator() == Operation.Operator.ADD && r instanceof IntConstant){
						...
						} else if (((Operation)r).getOperator() == Operation.Operator.ADD && l instanceof IntConstant){
