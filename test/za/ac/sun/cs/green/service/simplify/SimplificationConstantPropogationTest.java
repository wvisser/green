...
public class SimplificationConstantPropogationTest {
	...
	@Test
		public void test04() {
			IntConstant c1 = new IntConstant(4); //c1 = 4
			IntConstant c2 = new IntConstant(10); // c2 = 10
			Operation o1 = new Operation(Operation.Operator.LT, c1, c2); // c1 < c2
			Operation o2 = new Operation(Operation.Operator.GT, c1, c2); // c1 > c2
	...
	@Test
		public void test05() {
			...
			IntConstant c2 = new IntConstant(10);
			IntConstant c3 = new IntConstant(2);
			Operation o1 = new Operation(Operation.Operator.EQ, c, x);   // x==1
			Operation o2 = new Operation(Operation.Operator.ADD, x, y);  // x+y
			Operation o3 = new Operation(Operation.Operator.LT, o2, c2); // (x+y)<10
